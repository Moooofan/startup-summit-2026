...
const cornerBlob = [
  "radial-gradient(circle, rgb(160 120 255 / 0.5) 0%, rgb(160 120 255 / 0.14) 45%, transparent 70%)",
  "radial-gradient(circle, rgb(90 140 255 / 0.5) 0%, rgb(90 140 255 / 0.14) 45%, transparent 70%)",
  "radial-gradient(circle, rgb(80 200 245 / 0.45) 0%, rgb(80 200 245 / 0.13) 45%, transparent 70%)",
];
...
export function TicketsGallery() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute right-[-8%] top-[8%] h-[42vw] max-h-[560px] w-[42vw] max-w-[560px] rounded-full bg-[radial-gradient(circle,rgb(90_170_255/0.24)_0%,transparent_65%)]"
      />
      ...
      <div className="absolute bottom-6 left-1/2 z-30 flex -translate-x-1/2 items-center gap-3">
        <button
          ...
          className="btn-glass grid h-10 w-10 place-items-center rounded-full border border-line bg-white/[0.07] text-ink-3 transition-colors hover:text-brand-lift disabled:pointer-events-none disabled:opacity-30 sm:hidden"
        >
          ...
          {PAGE_NAMES.map((name, i) => (
            <button
              ...
              className={cn(
                ...
                i === page ? "w-7 bg-[rgb(60_110_255/0.85)]" : "w-2 bg-ink/20 hover:bg-ink/40"
              )}
            />
          ))}
        </div>
...
function NavArrow({
  ...
  return (
    ...
    >
      <span
        className={cn(
          "btn-glass grid h-12 w-12 place-items-center rounded-full border border-line bg-white/[0.07] text-ink-3 transition-all duration-300",
          ...
          "group-hover:shadow-[inset_0_1px_0_rgb(255_255_255/0.58),inset_0_-1px_0_rgb(255_255_255/0.16),0_0_20px_rgb(90_215_250/0.34)]",
  ...
  return (
    <PanelShell>
      ...
      >
        ...
        >
          <span className="block text-[17px] font-medium tracking-wide text-ink-3 transition-colors group-hover:text-aqua">
            向右瀏覽票種與聯絡資訊
          </span>
          <span className="relative mt-3 block h-8 w-full overflow-hidden">
            ...
            <span
              aria-hidden
              className="absolute inset-x-0 top-1/2 h-[3px] -translate-y-1/2 rounded-full bg-aqua/18"
            />
            ...
            >
              <span className="h-[3px] flex-1 rounded-full bg-gradient-to-r from-transparent to-aqua" />
              <ChevronRight size={30} strokeWidth={3} className="-ml-3 shrink-0 text-aqua" />
            </span>
          </span>
        </button>
      </div>
...
function TicketCard({
  ...
  return (
    ...
    <div
      className={cn(
        "rounded-[20px] border bg-[rgb(9_16_54/0.72)] p-2.5 shadow-[0_28px_70px_-28px_rgba(1,4,24,0.78)] sm:p-3",
        plan.featured ? "border-brand-lift/45" : "border-line"
      )}
    >
      <div
        className={cn(
          "relative overflow-hidden rounded-[13px] border bg-gradient-to-br from-orbit-sky/16 via-[rgb(12_22_70/0.5)] to-[#a98bff]/16 p-5 sm:p-7",
        ...
        <div className="mt-8 grid gap-3 sm:mt-10 sm:grid-cols-3 sm:gap-4">
          {channels.map(({ icon: Icon, label, value, href, external }, i) => (
            <a
              ...
              className="group relative block h-full overflow-hidden rounded-[16px] border border-line bg-white/[0.05] p-2 shadow-[0_18px_50px_-24px_rgba(1,4,24,0.72)] transition-colors duration-300 hover:border-brand-lift/45"
            >
              <span
                aria-hidden
              ...
              <div className="relative flex h-full flex-row items-center gap-4 rounded-[10px] border border-line-soft bg-white/[0.04] p-4 sm:flex-col sm:items-start sm:gap-0 sm:p-5">
                ...
                <span className="min-w-0 sm:mt-5">
                  <span className="block text-[17px] tracking-[0.14em] text-aqua">{label}</span>
